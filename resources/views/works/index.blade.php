                        ...
                        <li class="border p-2 mr-3 mb-3 col-sm-2">
                            ...
                            <div>
                                <ul class="d-flex flex-row justify-content-center mx-auto pr-3 pl-3">
                                    ...
                                    <li class="border rounded-circle px_12 w-25 text-center mr-1"><a @if($work->type == 1) href="edit/illust/{{$work->id}}" @elseif($work->type == 2) href="edit/novel/{{$work->id}}" @endif><i class="fas fa-edit"></i></a></li>
