                ...
                <div class="card-body">
                    ...
                    <form action="/works/update/novel/{{$work->id}}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control"  name="password_text" id="password_text" value="{{$work->password_text}}" cols="20" rows="3"></textarea>
                        </div>
                        ...
                        <div>
                            <p>キャプション：{{$work->caption}}</p>
                            <p>本文：{{$novel_work->content}}</p>
                        </div>
